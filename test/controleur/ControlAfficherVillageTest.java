...
class ControlAfficherVillageTest {
	...
	void testDonnerNomsVillageois() {
		...
		String[] donneesReçu = controlAfficherVillage.donnerNomsVillageois();
		String[] donneesAttendu = {"Abraracourcix","Bonemine","Astérix","le druide Panoramix"};
		assertArrayEquals(donneesAttendu, donneesReçu);
	}
